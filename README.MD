...
1. Скачайте образ: `docker pull boyarvaryag1/webgoat:8.0-ru-es`
2. Запустите контейнер: `docker run -p 8080:8080 boyarvaryag1/webgoat:8.0-ru-es`
...
1. Descarga la imagen: `docker pull boyarvaryag1/webgoat:8.0-ru-es`
2. Inicia el contenedor: `docker run -p 8080:8080 boyarvaryag1/webgoat:8.0-ru-es`
...
1. Download the image: `docker pull boyarvaryag1/webgoat:8.0-ru-es`
2. Run the container: `docker run -p 8080:8080 boyarvaryag1/webgoat:8.0-ru-es`
